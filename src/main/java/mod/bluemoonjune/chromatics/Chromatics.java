...
//import net.minecraftforge.server.FMLServerStartingEvent;
...
public class Chromatics
{
    ...
    public static class ChromaticsItemGroup extends CreativeModeTab {
...
//    }
    ...
    private static final NonNullSupplier<CreateRegistrate> REGISTRATE = CreateRegistrate.lazy("chromatics");
