...
import com.ovionyx.chromatics.common.items.models.RadiantChainsawModel;
import com.ovionyx.chromatics.common.items.models.RadiantRapierModel;
...
public class RadiantRapierRenderer extends CustomRenderedItemModelRenderer<RadiantRapierModel> {
    @Override
    protected void render(ItemStack stack, RadiantRapierModel model, PartialItemModelRenderer renderer, ItemCameraTransforms.TransformType transformType, MatrixStack ms, IRenderTypeBuffer buffer, int light, int overlay) {
