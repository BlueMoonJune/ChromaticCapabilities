...
public class RadiantKnifeRenderer extends CustomRenderedItemModelRenderer {
    protected static final PartialModel GEAR = new PartialModel(Chromatics.asResource("item/radiant_knife/gear"));
    protected static final PartialModel BLADE = new PartialModel(Chromatics.asResource("item/radiant_knife/blade"));
    protected static final PartialModel GLOW = new PartialModel(Chromatics.asResource("item/radiant_knife/glow"));
    protected static final PartialModel RADIANCE = new PartialModel(Chromatics.asResource("item/radiant_knife/radiance"));
    protected static final PartialModel TANK = new PartialModel(Chromatics.asResource("item/radiant_knife/tank"));
